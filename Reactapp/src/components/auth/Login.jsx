...
const Loginpage = () => {
    ...
    return (
        <>
<div className="container-fluid bg-gray-300 h-screen flex justify-center">
            <div class="w-full max-w-xs mt-16  mb-24">
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    {/* <div class="flex items-center justify-between">
                        ...
                        <a class="flex items-right  inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="#">
                            Forgot password?
                        </a>
                    </div> */}
